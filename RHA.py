# Decompile by Mardis (Tools By RED-MAFIA)
# Time Succes decompile : 2022-03-25 23:47:41.594755
import os
try:
    import requests
except ImportError:
...
def moch_yayan():
    ...
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Author : \x1b[0;93mRED-MAFIA' % (O, N)
    time.sleep(0.04)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Github : \x1b[0;93mRed-Mafia' % (O, N)
    time.sleep(0.04)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s WhatsApp   : \x1b[0;93m+923188214452' % (O, N)
    time.sleep(0.04)
    print '%s%s' % (O, N)
...
def info_tools():
    ...
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] WhatsApp  : 03188214452.' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Author    : RED-MAFIA.' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Github    : Https://github.com/Red-Mafia' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Facebook  : Red-Mafia' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Instagram : nahi hai' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    ...
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] ph  : 03188214452' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] Group : Turmux Commands RED-MAFIA' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    ...
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 (RED-MAFIA)' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 No Support its RED-MAFIA' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 Best Friend ALIRAZA' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 RK RED-MAFIA' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    ...
    time.sleep(0.09)
    print '%s[%s>%s] \xe2\x80\xa2 WhatsApp : 03188214452' % (N, H, N)
    time.sleep(0.09)
    print '%s[%s#%s]' % (N, O, N), 52 * '\x1b[1;96m-\x1b[0m'
    time.sleep(0.09)
    raw_input('\n[ %sBack%s ] ' % (O, N))
